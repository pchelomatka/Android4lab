...
import com.ru.edu.asu.nikivas.fourthlabnew.R.layout.activity_music_info
...
class MainActivity : AppCompatActivity() {
    ...
    var musicInfoButton: ImageButton? = null
                    ...
                    relativeLayout {
                        ...
                        verticalLayout {
                            ...
                            linearLayout {
                                ...
                                musicInfoButton = imageButton {
                                    imageResource = R.drawable.ic_arrow_bak
                                    onClick {
                                        val intent = Intent(it?.context, MusicInfoActivity::class.java)
                                ...
                                playButton = imageButton {
                                    imageResource = R.drawable.ic_to_main_page
                                    onClick {
                                        playOrPause()
                                    }
                                }.lparams(0, wrapContent, 0.5f)
